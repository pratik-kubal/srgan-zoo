...
class SRGAN():
    # REF: https://github.com/pratik-kubal/Keras-GAN/blob/master/srgan/srgan.py
    def __init__(self,img_res):
        # Input shape
        self.channels = 3
        self.lr_height = img_res[0]          # Low resolution height
        self.lr_width = img_res[1]                  # Low resolution width
